...
- [Синтаксис Handlebars](syntax.md) — вирази, парціали, блоки, шляхи, істинність
...
- [API шаблонів](api.md) — рантайм API для скомпільованих шаблонів (контекст, хелпери, парціали)
...
- [Процесор та веб-сервер](processor-server.md) — CLI `hbc build`/server, формат даних, спільні дані
